    ...
    def _compute(self,
        ...
        def compute_single_energy(args, approx=False):
            ...
            if self.is_ER:
                ...
                p_nq=cutsom_grad_gather(p_nq_1D,index_nq[:,o],0)
                ...
                p_ni=cutsom_grad_gather(p_ni_2D,index_nq[:,o],0)
                ...
                p_nq=cutsom_grad_gather(p_nq_2D,index_nq[:,o],0)
            ...
            p_nel=cutsom_grad_gather(p_nel_1D,index_nel[:,o],0)
